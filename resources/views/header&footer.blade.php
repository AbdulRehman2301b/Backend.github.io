    ...
    <link rel="stylesheet" href="css/style.css">
                              ...
                              <nav class="navbar py-4 navbar-expand-lg ftco_navbar navbar-light bg-light flex-row">
                                <div class="container">
                                  <div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
                                    ...
                                    <a class="navbar-brand logo_h" href="/"><img src="images/logo.png" alt="" style="padding-right:3rem;"></a>
                                    </div>
                                ...
                                {{-- <li class="nav-item dropdown no-arrow"> --}}
                                  <a class="nav-link" href="#" id="userDropdown" role="button"
                                      data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img class="img-xs rounded-circle" src="../docassets/images/faces/face8.jpg" alt="Profile image">
                                  </a>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
                          <div class="container d-flex align-items-center">
                            ...
                            <p class="button-custom order-lg-last mb-0"><a href="/appointment" class="btn btn-primary py-2 px-3">Make An Appointment</a></p>
...
@yield('content')
    ...
    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="/index" target="_blank">MedCare</a>
