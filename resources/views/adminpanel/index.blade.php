                          ...
                          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="card" style="border-radius: 15px;border-color: rgb(97, 97, 255);">
                              <div class="card-body p-5">
                                <h2 class="text-uppercase text-center mb-5">ADD CITIES</h2>
                  
                                <form action="/addcities" method="POST">
                                  @csrf

                                  <div class="form-outline mb-4">
                                    <input type="text" id="form3Example1cg" class="form-control form-control-lg" name="cities"/>
                                    <label class="form-label" for="form3Example1cg">ADD CITIES HERE</label>
                                  </div>
                  
                                  <div class="d-flex justify-content-center">
                                    <button type="submit"
                                      class="btn btn-primary btn-block btn-lg gradient-custom-4 text-body-light">Register</button>
                                  </div>
                                </form>
