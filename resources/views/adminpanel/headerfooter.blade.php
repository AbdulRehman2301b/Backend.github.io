...
<head>
    ...
    <title>Welcome In Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Patients_Appointments</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">View Patients Details:</h6>
                        <a class="collapse-item" href="/patient">View Paients Data</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Contact Us Info:</h6>
                        <a class="collapse-item" href="/contactdetails">View Contact</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="/cities">
                    <span>Cities Management Here</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/doctorform">
                    <span>Add Doctors</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="/fetchdoctor">
                    <span>View Doctors Management</span></a>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../adminassets/img/staff-1.jpg">
                            </a>
