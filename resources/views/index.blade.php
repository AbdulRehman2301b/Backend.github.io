...
@endif  
   ...
   @section('content')
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image:url(images/home-banner.jpg)">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 text ftco-animate">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 d-flex align-items-center">
						<p class="mb-0"><a href="/appointment" class="btn btn-warning px-4 py-3">Make An Appointment</a></p>
					</div>
				</div>
			</div>
		</section>
